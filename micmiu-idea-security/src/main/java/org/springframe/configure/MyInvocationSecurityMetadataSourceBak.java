...
//    private Collection<String> unbindResources = null;
    /**
     *
     * 程序启动的时候就加载所有资源信息
     * 初始化资源与权限的映射关系
    ...
    public void init(){
        ...
        //获取所有未关联的资源列表
        //select * from resources where id not in (select distinct rid from role_res)
        //上面是伪sql按照你的表和字段对应下就OK了.
        //这里把接口写好,你老打我名字干啥!!!!!!! unbindResources = systemResourcesDao.getList();
